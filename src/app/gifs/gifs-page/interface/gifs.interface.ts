// To parse this data:
//
//   import { Convert, ShearchGifsResponse } from "./file";
//
//   const shearchGifsResponse = Convert.toShearchGifsResponse(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface ShearchGifsResponse {
    data:       Gif[];
...
export class Convert {
    public static toShearchGifsResponse(json: string): ShearchGifsResponse {
        return cast(JSON.parse(json), r("ShearchGifsResponse"));
    }

    public static shearchGifsResponseToJson(value: ShearchGifsResponse): string {
        return JSON.stringify(uncast(value, r("ShearchGifsResponse")), null, 2);
    }
}
